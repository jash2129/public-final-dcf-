    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button 
          ...
          className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-xl text-sm font-bold text-slate-600 hover:text-dark hover:border-slate-300 transition-all shadow-sm"
        >
          ...
          {isLoading ? (
            ...
            filteredServices.map((service) => (
              <motion.div
                ...
                key={service.id}
                className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md hover:border-slate-200 transition-all flex flex-col justify-between group relative overflow-hidden"
              >
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-slate-500 font-sans leading-relaxed line-clamp-3 font-medium min-h-[54px]">
                ...
                <div className="mt-6 pt-4 border-t border-slate-50 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3.5 py-2 bg-slate-50 border border-slate-100 hover:bg-brand hover:border-brand hover:text-dark text-slate-500 rounded-xl text-xs font-bold transition-all shadow-sm cursor-pointer"
                  >
