    ...
    <div className="overflow-hidden">
      ...
      <section className="bg-dark text-white pt-28 pb-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="hidden md:block absolute -top-[20%] -right-[10%] w-[70%] h-[70%] rounded-full bg-brand/25 blur-3xl transform-gpu"></div>
          <div className="hidden md:block absolute top-[45%] -left-[10%] w-[50%] h-[50%] rounded-full bg-secondary/20 blur-3xl transform-gpu"></div>
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-5 hidden lg:block relative">
            <div
              ...
              className="relative bg-white/5 border border-white/10 rounded-3xl p-6 shadow-2xl backdrop-blur-xl"
            >
              {/* Card Header */}
            ...
            <div className="hidden md:block absolute -bottom-6 -left-6 w-32 h-32 bg-secondary/30 rounded-full blur-2xl -z-10"></div>
          </div>
        </div>
      </section>
        ...
        <section className="py-24 bg-slate-50">
          <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-dark mb-6">Explore Our Services</h2>
              <p className="text-xl text-dark-400 max-w-2xl mx-auto">Comprehensive legal, tax, and compliance solutions for your business.</p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {serviceCategories.map((category) => (
                <div key={category.title}  className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
        ...
        <section className="py-20 bg-brand-lightest border-b border-brand-light">
          <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div  className="flex flex-col items-center p-10 bg-white rounded-3xl shadow-sm border border-brand-light">
