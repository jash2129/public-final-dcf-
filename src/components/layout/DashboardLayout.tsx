...
export default function DashboardLayout() {
  ...
  const toolItems = [
    { 
      name: 'GST Calculator', 
      path: user.role === 'admin' || user.role === 'super_admin' ? '/admin/tools/gst-calculator' : '/dashboard/tools/gst-calculator', 
      icon: Calculator 
    },
    { 
      name: 'Compliance Calendar', 
      path: user.role === 'admin' || user.role === 'super_admin' ? '/admin/tools/compliance-calendar' : '/dashboard/tools/compliance-calendar', 
      icon: CalendarCheck 
    },
  ];
